...
export declare namespace ITPFtOperation1052 {
...
export interface ITPFtOperation1052Interface extends utils.Interface {
  functions: {
    "trade(uint256,uint256,uint256,uint8,(string,string,uint256),uint256,uint256)": FunctionFragment;
    "trade(uint256,address,address,uint8,(string,string,uint256),uint256,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "trade(uint256,uint256,uint256,uint8,(string,string,uint256),uint256,uint256)",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
      ITPFtOperation1052.TPFtDataStruct,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>
    ]
  ): string;
  encodeFunctionData(
    functionFragment: "trade(uint256,address,address,uint8,(string,string,uint256),uint256,uint256)",
    values: [
      PromiseOrValue<BigNumberish>,
...
export interface CommandEventEventObject {
  ...
  receiver: string;
  callerPart: number;
  tpftData: ITPFtOperation1052.TPFtDataStructOutput;
...
export type CommandEventEvent = TypedEvent<
  [
    ...
    string,
    number,
    ITPFtOperation1052.TPFtDataStructOutput,
    BigNumber,
    BigNumber,
    BigNumber,
    string,
...
export interface ITPFtOperation1052 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ITPFtOperation1052Interface;
  ...
  functions: {
    "trade(uint256,uint256,uint256,uint8,(string,string,uint256),uint256,uint256)"(
      ...
      tpftData: ITPFtOperation1052.TPFtDataStruct,
